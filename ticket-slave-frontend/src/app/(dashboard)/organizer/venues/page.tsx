...
import { MapPin, Plus, Search, Eye, Edit, Trash2, Building } from 'lucide-react'
...
export default function VenuesManagement() {
  ...
  const handleDeleteVenue = async (venueId: string) => {
    ...
    try {
      ...
      await loadVenues() // Recargar recintos
    } catch (error) {
      console.error('Error deleting venue:', error)
      alert('Error al eliminar el recinto. Puede que tenga eventos asociados.')
    }
  }
